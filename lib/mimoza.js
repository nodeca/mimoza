...
// cache mime files
var mimeTypes = fs.readFileSync(path.join(__dirname, '../types/mime.types'), 'ascii');
var nodeTypes = fs.readFileSync(path.join(__dirname, '../types/node.types'), 'ascii');
var compressibleTypes = fs.readFileSync(path.join(__dirname, '../types/compressible.types'), 'ascii');
...
var Mimoza = module.exports = function Mimoza(options) {
  ...
  if (options.preloaded) {
    this.loadMimes(mimeTypes);
    this.loadMimes(nodeTypes);
    this.loadCompressibles(compressibleTypes);
  }
};
